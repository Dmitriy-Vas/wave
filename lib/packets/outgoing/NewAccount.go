...
func (d *NewAccountPacket) GetID() int64 {
	return d.ID
}

// SetID sets ID to the packet.
func (d *NewAccountPacket) SetID(id int64) {
	d.ID = id
}

// GetSend returns whether to send this packet.
func (d *NewAccountPacket) GetSend() bool {
	return d.Send
}

// SetSend sets whether to send this packet.
func (d *NewAccountPacket) SetSend(value bool) {
	d.Send = value
}
