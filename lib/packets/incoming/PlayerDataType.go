...
func (d *PlayerDataTypePacket) GetID() int64 {
	return d.ID
}

// SetID sets ID to the packet.
func (d *PlayerDataTypePacket) SetID(id int64) {
	d.ID = id
}

// GetSend returns whether to send this packet.
func (d *PlayerDataTypePacket) GetSend() bool {
	return d.Send
}

// SetSend sets whether to send this packet.
func (d *PlayerDataTypePacket) SetSend(value bool) {
	d.Send = value
}
