...
func (d *ResourceCachePacket) GetID() int64 {
	return d.ID
}

// SetID sets ID to the packet.
func (d *ResourceCachePacket) SetID(id int64) {
	d.ID = id
}

// GetSend returns whether to send this packet.
func (d *ResourceCachePacket) GetSend() bool {
	return d.Send
}

// SetSend sets whether to send this packet.
func (d *ResourceCachePacket) SetSend(value bool) {
	d.Send = value
}
