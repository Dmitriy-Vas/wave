...
func (d *PlayerRankPacket) GetID() int64 {
	return d.ID
}

// SetID sets ID to the packet.
func (d *PlayerRankPacket) SetID(id int64) {
	d.ID = id
}

// GetSend returns whether to send this packet.
func (d *PlayerRankPacket) GetSend() bool {
	return d.Send
}

// SetSend sets whether to send this packet.
func (d *PlayerRankPacket) SetSend(value bool) {
	d.Send = value
}
