...
func (d *PartyVitalsPacket) GetID() int64 {
	return d.ID
}

// SetID sets ID to the packet.
func (d *PartyVitalsPacket) SetID(id int64) {
	d.ID = id
}

// GetSend returns whether to send this packet.
func (d *PartyVitalsPacket) GetSend() bool {
	return d.Send
}

// SetSend sets whether to send this packet.
func (d *PartyVitalsPacket) SetSend(value bool) {
	d.Send = value
}
